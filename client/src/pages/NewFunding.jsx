...
const NewFunding = () => {
  ...
  const [newFundCard, setNewFundCard] = useState(1);
  ...
  const handleNewFundriser = async ()=>{

      await axios.post('http://localhost:6001/new-fundriser', {applicantId: userId, applicantName, applicantEmail, applicantMobile, fundriserPurpose, title, description, bannerImage, deadline, targetAmount, extraImg1, extraImg2, extraImg3, collectedAmount: 0}).then(
        (response)=>{
            ...
            <div className="new-fundriser-card">
              ...
              <div className="new-fundriser-form">
                  ...
                  <span className='new-fundriser-btns' >
                    ...
                    <button className='new-fundriser-orangeBtn' onClick={()=> setNewFundCard(2)} >Next <ImArrowRight2 /> </button>
                  </span>
          ...
          {newFundCard === 2 ?
            ...
            <div className="new-fundriser-card">
              ...
              <div className="new-fundriser-form">
                  ...
                  <span className='new-fundriser-btns' >
                    <button className='new-fundriser-blueBtn' onClick={()=> setNewFundCard(1)}> <ImArrowLeft2 /> Back</button>
                    <button className='new-fundriser-orangeBtn' onClick={handleNewFundriser} >Finish <ImArrowRight2 /> </button>
                  </span>
